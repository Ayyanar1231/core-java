...
public class AppointmentsUI {
	...
	public static void addNewAppointments() {
		...
		try {
			...
			app.setFees_Amount(Integer.parseUnsignedInt(fees_collected));

			System.out.println("Enter Fees collection :");
			app.setFees_Collected(sc.nextFloat());
	...
	public static void viewAppointmentDetails() {
		...
		try {
			...
			System.out.println("fees Amounts:"+doc.getFees_Amount());
			System.out.println("fees collection:" + doc.getFees_Collected());
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
			try {
	...
	public static void updateAppointmentDetails() {
		...
		try {
			...
			app.setFees_Amount(Integer.parseInt(fees_Amounts));

			System.out.println("Enter the Fees collection :");
			float fees_collection= sc.nextFloat();
